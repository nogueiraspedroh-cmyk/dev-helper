// js/tools-en/sql.js — logic for the SQL Indenter/Formatter (English version).
// Loaded ONLY on en/tools/sql/index.html, after js/main.js.
// Mirrors js/tools/sql.js — same logic, only user-visible strings translated.
