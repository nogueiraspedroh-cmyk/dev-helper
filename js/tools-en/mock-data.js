// js/tools-en/mock-data.js — fake/mock JSON data generator (English version).
// Loaded ONLY on en/tools/mock-data/index.html, after js/main.js.
// Mirrors js/tools/mock-data.js — same logic, only user-visible strings translated.
...
(function () {
  ...
  btnGen.addEventListener("click", function () {
    ...
    if (!count || count < 1) { showError("Enter a quantity from 1 to 1000."); return; }
    if (count > 1000) { showError("Maximum of 1000 records per generation."); return; }
    var opts = readOpts();
    var anyField = FIELD_IDS.some(function (k) { return opts[k]; });
    if (!anyField) { showError("Select at least one field."); return; }
