// js/tools-en/contador-caracteres.js — live character/word counter (English version).
// Loaded ONLY on en/tools/contador-caracteres/index.html, after js/main.js.
// Mirrors js/tools/contador-caracteres.js — same logic, only user-visible strings translated.
...
(function () {
  ...
  var LIMITS = [
    { id: "tweet", label: "X (Twitter) post", limit: 280 },
  ...
  function renderLimits(charsWith) {
    ...
    statuses.forEach(function (s) {
      ...
      if (s.exceeded) {
        status.textContent = "exceeded by " + Math.abs(s.remaining);
      } else {
        status.textContent = s.remaining + " remaining";
      }
