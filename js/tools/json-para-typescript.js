// js/tools/json-para-typescript.js — infere interfaces TypeScript de um JSON.
// Carregado APENAS em tools/json-para-typescript/index.html, após js/main.js.
...
(function () {
  ...
  function run() {
    ...
    try {
      ...
      elOutput.value = "";
      showError("JSON inválido: " + (e && e.message ? e.message : "não foi possível interpretar."));
    }
  }
